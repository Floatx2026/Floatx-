...
export function DebtComingSoon() {
  return (
    <section id="early-access" className="bg-white py-24 scroll-mt-24">
      <div className="max-w-[1200px] mx-auto px-6">
        <div className="bg-cream border border-line rounded-[28px] shadow-[0_18px_40px_-22px_rgba(22,35,71,0.16)] p-10 min-[900px]:p-14">
          <div className="grid grid-cols-1 min-[900px]:grid-cols-[1.4fr_1fr] gap-10 items-center">
            <div>
              ...
              <h2 className="font-serif italic font-normal text-navy text-[clamp(28px,3.4vw,40px)] leading-[1.15] m-0 mb-4 max-w-[20ch]">
                Debt investments are coming to FloatX.
              </h2>
              <p className="text-[15px] leading-[1.65] text-ink/[0.78] m-0 max-w-[58ch]">
                We&apos;re onboarding fixed-income and property-loan managers ahead of launch. Register early access to be notified when allocations open to wholesale members.
              </p>
            </div>
