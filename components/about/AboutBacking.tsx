const partners = [
  ...
  },
  {
    initials: "SSE",
    name: "SSE",
    desc: "Associated regulatory and exchange partner supporting FloatX's cross-border investment and trading operations.",
  },
];
      ...
      <div className="max-w-[1200px] mx-auto px-6">
        ...
        <div className="grid grid-cols-1 min-[700px]:grid-cols-3 gap-6">
          {partners.map((p) => (
            ...
            >
              <div className="w-12 h-12 rounded-[10px] bg-tan/20 text-tan flex items-center justify-center text-[11px] font-bold tracking-wide mb-5">
                {p.initials}
              </div>
