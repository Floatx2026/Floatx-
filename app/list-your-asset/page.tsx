...
export const metadata = {
  ...
  description:
    "List your company, fund or asset on FloatX and gain access to 60,000+ global accredited investors. Private trading, capital raising, debt and property — go live in as little as 48 hours.",
};
